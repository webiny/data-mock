...
/**
 * That the environment exists and belongs to this project is checked in `routeFactory`, for every
 * route carrying both ids — see `checkEnvironmentOwnership`. Without it, enqueueing against an id
 * that does not exist surfaced as a foreign-key 500 rather than a 404.
 */
