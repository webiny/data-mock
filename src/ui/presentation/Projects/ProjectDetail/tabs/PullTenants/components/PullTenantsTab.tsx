...
import type { ISyncLogVM } from "../abstractions/PullTenantsTabPresenter.js";
...
interface PullTenantsTabProps {
  context: ProjectDetailTabContext;
}

export const PullTenantsTab = observer(function PullTenantsTab({ context }: PullTenantsTabProps) {
  const { presenter } = useFeature(PullTenantsTabFeature);
  ...
  return (
    <Stack gap="md">
      <Group justify="space-between">
        <Button loading={vm.isSyncingTenants} onClick={() => presenter.pullTenants()}>
          Pull Tenants
        </Button>
