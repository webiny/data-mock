...
Agents copied from `reference-project/.claude/agents/` and adapted for the webiny-mock-data project.
...
| `ui-designer.md` | `ui-designer.md` | Replaced Mantine v9 references with generic component library; replaced Croatian UI language with English; adapted file map from reference project domain (Series, Auth) to data-mock domain (Projects, Models, Seeding); replaced MobX references with generic "observable"; updated "Must NOT Touch" list for data-mock file patterns |
